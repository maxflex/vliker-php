...
<div id="like-blocks">
	...
	<div class="block-line">
		<div class="vliker-block" id="block-1" data-block-id="1">
			<?= $Tasks[0]->display() ?>
		</div>
		<div class="vliker-block" id="block-2" data-block-id="2">
			<?= $Tasks[1]->display() ?>
		</div>
		<div class="vliker-block" id="block-3" data-block-id="3">
			<?= $Tasks[2]->display() ?>
		</div>
	</div>	
	
	<div class="block-line">
		<div class="vliker-block" id="block-4" data-block-id="4">
			<?= $Tasks[3]->display() ?>
		</div>
		<div class="vliker-block" id="block-5" data-block-id="5">
			<?= $Tasks[4]->display() ?>
		</div>
		<div class="vliker-block" id="block-6" data-block-id="6">
			<?= $Tasks[5]->display() ?>
		</div>
	</div>
</div>
...
<div class="row" id="row-process-control">
	<div class="col-sm-12" style="padding: 0 40px; margin-top: 20px; text-align: center">
		<div class="btn-group btn-group-justified">
	        ...
	        <ul class="dropdown-menu" role="menu">
	          <li><a href="#">Страница была недоступна</a></li>
	          <li><a href="#">Страница уже отображалась</a></li>
			  <li><a href="#">Спам</a></li>
	        </ul>
	      </div>
			...
			<a onclick="stop()" class="btn btn-primary"><span class="glyphicon glyphicon-stop"></span>Завершить</a>
		</div>
	</div>
</div>